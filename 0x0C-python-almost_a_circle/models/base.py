...
class Base:
    ...
    Attribute:
        __nb_objects (): The number of instanciated bases.
    """
    __nb_objects = 0
    ...
    def from_json_string(json_string):
        """Returns the list of the JSON string representing json_string.
    ...
    def draw(list_rectangles, list_squares):
        ...
        for rect in list_rectangles:
            ...
            for index in range(2):
                turt.forwad(rect.width)
                turt.left(90)
                turt.forwad(rect.height)
                turt.left(90)
            turt.hideturtle()
        turt.color(#b5e3d8")
